export default function DashboardLoading() {
  return (
    <main className="relative min-h-screen overflow-hidden bg-black px-6 text-white">
      ...
      <section className="relative z-10 mx-auto flex min-h-screen w-full max-w-4xl flex-col justify-center">
        <p className="text-sm text-neutral-400">matchr</p>
        <h1 className="mt-2 text-4xl font-black tracking-tight">Dashboard</h1>
        <div className="mt-10 rounded-lg border border-neutral-800 bg-black/40 p-6">
