...
export function AppShell({
  ...
  return (
    <main className={`matchr-app-shell relative h-[100dvh] min-h-[100dvh] overflow-x-hidden overflow-y-auto overscroll-y-auto bg-black text-white ${hideNav ? "" : "md:pl-64"}`}>
