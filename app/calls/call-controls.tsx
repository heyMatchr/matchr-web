    ...
    <>
      <div className="flex min-w-fit shrink-0 items-center gap-1 sm:gap-2">
        <button
          ...
          title="Audio call"
          className="inline-flex h-8 w-8 shrink-0 items-center justify-center gap-2 rounded-full border border-emerald-300/30 text-emerald-100 transition-colors hover:bg-emerald-300/10 disabled:opacity-60 sm:h-9 sm:w-9 md:w-auto md:px-3"
        >
          <PhoneIcon />
